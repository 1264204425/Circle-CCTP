...
export default function ConnectButton() {
    ...
    const onConnectMetaMask = async () => {
        try {
            ...
            // const coinSymbol = await getCoinSymbol(formatChainAsNum(wallet.chainId));
            // setGlobalData({ ...globalData, coinSymbol }); // 更新 coinSymbol

            setGlobalData(await getNetworkInfo(formatChainAsNum(wallet.chainId)));
                    ...
                    <Dropdown>
                        <DropdownTrigger className="w-30">
                            <Button
                                ...
                                endContent={<DownSmall theme="multi-color" size="25"
                                                       fill={['#ffffff', '#2F88FF', '#FFF', '#43CCF8']} strokeWidth={2}
                        ...
                        <DropdownMenu aria-label="Static Actions">
                            ...
                            >
                                <div className="flex flex-row">
                                    <span>Balance:</span>
                                    <span>{balance}{globalData.coinSymbol}</span>
                                </div>
                            </DropdownItem>
                            <DropdownItem
                                key="delete"
